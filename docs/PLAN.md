...
**36화면 + 로그인 전체 완료 ✅**
- MON (6) + DSH (8) + ALT (6) + ANL (8) + SET (7) + Login = 36화면
- ANL006~008: 기간별 비교 (2026-03-11)
- ANL009~010: 전력/에어 상세 비교 + 싸이클 타임라인 (2026-03-11)
- ANL011: 싸이클 분석 (단일 설비, 2026-03-12)
- SET015: 시스템 설정 (2026-03-07)
