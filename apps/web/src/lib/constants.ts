...
export const SIDEBAR_MENUS: Record<GnbMenuId, SidebarEntry[]> = {
  monitoring: [
    ...
    { group: 'HMGMA 화면 모음' },
    { id: 'factory-map', label: '공장 평면도 (MON-007)', path: '/monitoring/factory-map' },
  ],
  dashboard: [
    ...
    { group: 'HMGMA 화면 모음' },
    { id: 'energy-flow',      label: '에너지 흐름도 (DSH-009)',     path: '/dashboard/energy-flow' },
    { id: 'shop-integrated',  label: 'Shop 통합 사용량 (DSH-010)',  path: '/dashboard/shop-integrated' },
    { id: 'energy-report',    label: '에너지 리포트 (DSH-011)',     path: '/dashboard/energy-report' },
  ],
  alert: [
  ...
  aux: [
    ...
    { id: 'hvac-rtu-status', label: 'RTU 평면도 상태 (HVC-002)', path: '/aux/hvac/rtu-status' },
    { id: 'hvac-rtu-detail', label: 'RTU 개별 제어 (HVC-003)',   path: '/aux/hvac/rtu-detail' },
    { group: '조명 (Lighting)' },
    { id: 'lighting-overview', label: '조명 종합 현황',           path: '/aux/lighting/overview' },
    { id: 'lighting-control',  label: '조명 제어 평면도 (LGT-002)', path: '/aux/lighting/control' },
    { group: '이력' },
  ...
  settings: [
    ...
    { id: 'aux-rtu-schedule',   label: 'RTU 운전 스케줄 (SET-021)', path: '/settings/aux-rtu-schedule' },
    { group: '알림·임계값' },
