...
export const SIDEBAR_MENUS: Record<GnbMenuId, SidebarEntry[]> = {
  monitoring: [
    ...
    { id: 'factory-map',    label: '공장 평면도',   path: '/monitoring/factory-map' },
    { group: '유틸리티 (라인별 전력·에어)' },
    ...
    { group: '공조 (Zone·온도·공조기)' },
    { id: 'hvac-overview-link', label: '공조 종합 현황', path: '/aux/hvac/overview' },
    { id: 'hvac-rtu-status',    label: 'RTU 평면도 상태', path: '/aux/hvac/rtu-status' },
    { group: '조명 (Zone·Relay·점등)' },
    { id: 'lighting-overview-link', label: '조명 종합 현황',   path: '/aux/lighting/overview' },
    { id: 'lighting-control-link',  label: '조명 제어 평면도', path: '/aux/lighting/control' },
  ],
  dashboard: [
    { group: '종합·흐름' },
    { id: 'energy-flow',         label: '에너지 흐름도',    path: '/dashboard/energy-flow' },
    ...
    { id: 'shop-integrated',     label: 'Shop 통합 사용량',  path: '/dashboard/shop-integrated' },
    { id: 'energy-change-top',   label: '에너지 변화 TOP N', path: '/dashboard/energy-change-top' },
    { group: '리포트' },
    { id: 'energy-report',       label: '에너지 리포트',     path: '/dashboard/energy-report' },
  ],
  alert: [
    ...
    { group: '부대설비 알림' },
    { id: 'hvac-fault',          label: '공조 이상',     path: '/alert/hvac-fault' },
    { id: 'light-fault',         label: '조명 이상',     path: '/alert/light-fault' },
    { id: 'interlock-violation', label: '인터록 위반',   path: '/alert/interlock-violation' },
  ],
  analysis: [
    { group: '설비별 추이 (일별)' },
  ...
  aux: [
    { group: '공조 (HVAC) — Zone·온도·공조기' },
    { id: 'hvac-overview',   label: '공조 종합 현황',   path: '/aux/hvac/overview' },
    { id: 'hvac-rtu-status', label: 'RTU 평면도 상태',  path: '/aux/hvac/rtu-status' },
    { id: 'hvac-rtu-detail', label: 'RTU 개별 제어',    path: '/aux/hvac/rtu-detail' },
    { group: '조명 (Lighting) — Zone·Relay·스케줄' },
    { id: 'lighting-overview', label: '조명 종합 현황',   path: '/aux/lighting/overview' },
    { id: 'lighting-control',  label: '조명 제어 평면도', path: '/aux/lighting/control' },
    { id: 'lighting-relays',   label: 'Relay 목록',       path: '/aux/lighting/relays' },
    { group: '이력' },
    { id: 'control-history', label: '제어 명령 이력', path: '/aux/control-history' },
  ],
  settings: [
    { group: '사이트·공장·라인·설비' },
    { id: 'site', label: '사이트 관리', path: '/settings/site' },
    ...
    { group: '공조 (HVAC) 설정' },
    { id: 'aux-zones',          label: '공간 마스터 (Zones)',       path: '/settings/aux-zones' },
    { id: 'aux-rtu-schedule',   label: 'RTU 운전 스케줄',           path: '/settings/aux-rtu-schedule' },
    { group: '조명 (Lighting) 설정' },
    { id: 'aux-lighting-relays', label: '조명 Relay 마스터', path: '/settings/aux-lighting-relays' },
    { id: 'aux-lux-standards',   label: '작업조도 기준',     path: '/settings/aux-lux-standards' },
    { group: '공통 설정' },
    { id: 'aux-schedule-rules', label: '운전 스케줄 룰', path: '/settings/aux-schedule-rules' },
    { group: '알림·임계값' },
