-- ============================================================
-- i-FEMS Continuous Aggregates + Reset Events (v2 - No JOIN)
-- Created: 2026-03-03
-- Description: TimescaleDB Continuous Aggregates 생성 + 리셋 이벤트 관리
-- JOIN 제거하고 tag_data_raw의 메타데이터 컬럼 활용
-- ============================================================
...
-- ============================================================
-- 2. USAGE Continuous Aggregate (1분) - JOIN 제거
-- ============================================================
...
GROUP BY bucket, "tagId", "facilityId", "energyType"
WITH NO DATA;
...
-- ============================================================
-- 4. TREND Continuous Aggregate (10초) - JOIN 제거
-- ============================================================
...
-- ============================================================
-- 5. SENSOR Continuous Aggregate (10초) - JOIN 제거
-- ============================================================
...
SELECT
  ...
  COUNT(*) as data_count
FROM tag_data_raw
WHERE "tagType" = 'SENSOR'
  AND "numericValue" IS NOT NULL
GROUP BY bucket, "tagId", "facilityId"
WITH NO DATA;
...
BEGIN
  ...
  RAISE NOTICE '⚡ No JOINs - Using denormalized metadata from tag_data_raw';
END $$;
